...
{
    public class StateTreiSyncLogUtility
    {
        public static async Task Log(string message)
        {
            try
            {
                ...
                await File.WriteAllTextAsync(path + "statesynclog.txt", text);
            }
            catch (Exception ex)
            {
        ...
        public static async Task DeleteLog()
        {
            try
            {
                var databaseLocation = Globals.IsTestNet != true ? "Databases" : "DatabasesTestNet";
                ...
                File.Delete(path + "statesynclog.txt");
            }
            catch { }
        }
