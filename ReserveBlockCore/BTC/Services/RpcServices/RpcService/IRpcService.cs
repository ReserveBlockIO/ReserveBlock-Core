...
using ReserveBlockCore.BTC.Requests.AddNode;
using ReserveBlockCore.BTC.Requests.CreateRawTransaction;
using ReserveBlockCore.BTC.Requests.SignRawTransaction;
using ReserveBlockCore.BTC.Responses;

namespace ReserveBlockCore.BTC.Services.RpcServices.RpcService
{
