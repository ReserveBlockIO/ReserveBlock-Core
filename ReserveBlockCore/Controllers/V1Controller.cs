...
namespace ReserveBlockCore.Controllers
{
    ...
    public class V1Controller : ControllerBase
    {
        ...
        public async Task<IActionResult> Debug()
        {
            ...
            htmlBuilder.AppendLine("    opacity: 0.40; /* Adjust opacity for subtle effect */");
            ...
            htmlBuilder.AppendLine("}");
            htmlBuilder.AppendLine(".glitch {");
            htmlBuilder.AppendLine("    position: fixed; /* Keep the glitch effect fixed within the viewport */");
            htmlBuilder.AppendLine("    top: 0;");
            htmlBuilder.AppendLine("    left: 0;");
            htmlBuilder.AppendLine("    width: 100%; /* Full width of the viewport */");
            htmlBuilder.AppendLine("    height: 100%; /* Full height of the viewport */");
            htmlBuilder.AppendLine("    z-index: -1; /* Place the glitch effect behind other content */");
            htmlBuilder.AppendLine("    background-image: url('data:image/png;base64,');");
            htmlBuilder.AppendLine("    animation: glitch-animation 1s infinite;");
            htmlBuilder.AppendLine("}");
            ...
            htmlBuilder.AppendLine("    }");
            htmlBuilder.AppendLine("}");
            htmlBuilder.AppendLine("@keyframes glitch-animation {");
            htmlBuilder.AppendLine("    0% {");
            htmlBuilder.AppendLine("        clip-path: polygon(0 0, 100% 0, 100% 100%, 0% 100%);");
            htmlBuilder.AppendLine("        transform: translate(0);");
            htmlBuilder.AppendLine("    }");
            htmlBuilder.AppendLine("    25% {");
            htmlBuilder.AppendLine("        clip-path: polygon(0 0, 100% 0, 100% 100%, 0% 100%);");
            htmlBuilder.AppendLine("        transform: translate(-5px, 0);");
            htmlBuilder.AppendLine("    }");
            htmlBuilder.AppendLine("    50% {");
            htmlBuilder.AppendLine("        clip-path: polygon(0 0, 100% 0, 100% 100%, 0% 100%);");
            htmlBuilder.AppendLine("        transform: translate(5px, 0);");
            htmlBuilder.AppendLine("    }");
            htmlBuilder.AppendLine("    75% {");
            htmlBuilder.AppendLine("        clip-path: polygon(0 0, 100% 0, 100% 100%, 0% 100%);");
            htmlBuilder.AppendLine("        transform: translate(0);");
            htmlBuilder.AppendLine("    }");
            htmlBuilder.AppendLine("    100% {");
            ...
            htmlBuilder.AppendLine("<div class=\"glitch\"></div>");
